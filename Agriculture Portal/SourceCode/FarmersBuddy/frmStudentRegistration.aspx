<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" EnableEventValidation="false" Theme="Theme1" AutoEventWireup="true"
    CodeFile="frmStudentRegistration.aspx.cs" Inherits="frmStudentRegistration" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        <h3 style="text-align: center; text-decoration: underline;">
            Agriculture Students' Registration Page</h3>
        ...
        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat ="server" ControlToValidate ="txtUserName" ErrorMessage ="*"></asp:RequiredFieldValidator></td>
        <td></td><td>Password</td><td><asp:TextBox ID="txtPassword" runat ="server" 
                TextMode="Password" MaxLength="8"  ></asp:TextBox></td>
                <td><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat ="server" ControlToValidate ="txtPassword" ErrorMessage ="*"></asp:RequiredFieldValidator></td>
        </tr>
        <tr><td>Confirm Password</td><td><asp:TextBox ID="txtConform" runat ="server" MaxLength="8" 
